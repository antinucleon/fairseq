...
class MaskedLMConvModel(FairseqEncoderModel):
    """
    ...
    def build_model(cls, args, task):
        ...
        encoder = MaskedLMConvEncoder(args, task.dictionary)
        return cls(args, encoder)


class MaskedLMConvEncoder(FairseqEncoder):
    """
    ...
    def __init__(self, args, dictionary):
        ...
        self.sentence_encoder = MPConvSentenceEncoder(
            padding_idx=self.padding_idx,
            vocab_size=self.vocab_size,
            num_encoder_layers=args.encoder_layers,
            embedding_dim=args.encoder_embed_dim,
            ffn_channel_dim=args.encoder_ffn_embed_dim,
    ...
    def forward(self, src_tokens, segment_labels=None, masked_tokens=None, **unused):
        ...
        #TBC->BTC
        x = inner_states[-1].transpose(2, 1)
...
@register_model_architecture("masked_lm_conv", "masked_lm_conv")
...
@register_model_architecture("masked_lm_conv", "mpconv_base")
def mp_conv_base(args):
